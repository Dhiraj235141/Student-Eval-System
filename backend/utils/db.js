  ...
  const connectWithRetry = () => {
    mongoose.connect(MONGO_URI, connOptions)
      ...
      .catch((err) => {
        ...
        if (err.message.includes('ECONNREFUSED') && (MONGO_URI.includes('106.192.121.32') || MONGO_URI.includes('localhost'))) {
...
//   // ✅ FIX: Only use Atlas URI (no localhost fallback)
...
//         // Auto-Repair ONLY for localhost (not Atlas)
//         if (
