...
import { Users, BookOpen, Clock, BarChart3, Presentation, PlusSquare, MessageSquare, Send, HelpCircle, Bug, AlertTriangle, Heart, Lightbulb, Loader2, CheckCircle2 } from 'lucide-react';
...
export default function FacultyDashboard() {
  ...
  const actions = [
    { label: 'Generate Test', desc: 'Create AI-powered MCQ test', icon: PlusSquare, path: '/faculty/create-test', color: 'from-purple-500 to-purple-600' },
    { label: 'Take Attendance', desc: 'Generate attendance codes', icon: Clock, path: '/faculty/attendance', color: 'from-amber-500 to-orange-500' },
    { label: 'Grade Submissions', desc: 'View assignment PDFs', icon: BookOpen, path: '/faculty/assignments', color: 'from-cyan-500 to-blue-500' },
    { label: 'Send Note', desc: 'Notify your students', icon: Users, path: '/faculty/announcements', color: 'from-pink-500 to-rose-500' },
  ];
